...
ArrayList<String> truthArray=new ArrayList<String>();
    ...
    for(List<PageNumberCandidate> b: book){
			...
			System.out.println(0+" "+"1:"+PNC.features.get("is a number")+" "+"2:"+PNC.features.get("does look like a number")+" "+"3:"+PNC.features.get("x-fraction")+" "+"4:"+PNC.features.get("sequence")+" "+"5:"+PNC.features.get("y-fraction")+" "+"6:"+PNC.features.get("downward % thru line")+" "+"7:"+PNC.features.get("upward % thru line")+" "+"8:"+PNC.features.get("downward % thru page")+" "+"9:"+PNC.features.get("upward % thru page")+" #"+PNC.imageNumber()+","+PNC.text+","+PNC.book());
	...
	public void generateRankData(PrintWriter output, PrintWriter qidOutput ,List<List<PageNumberCandidate>> book) throws FileNotFoundException{
